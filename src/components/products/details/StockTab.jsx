                    ...
                    <Table className="min-w-[650px]" aria-label="historial stock table">
                        <TableHead>
                            <TableRow className="bg-slate-50">
                                <TableCell className="font-bold text-slate-600 text-xs uppercase">Fecha</TableCell>
                                <TableCell className="font-bold text-slate-600 text-xs uppercase">Operación</TableCell>
                                <TableCell align="right" className="font-bold text-slate-600 text-xs uppercase">Anterior</TableCell>
                                <TableCell align="center" className="w-[50px]"></TableCell>
                                <TableCell align="left" className="font-bold text-slate-600 text-xs uppercase">Nuevo</TableCell>
                                <TableCell className="font-bold text-slate-600 text-xs uppercase">Usuario</TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
